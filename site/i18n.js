...
window.I18N = {
  ...
  fr: {
    ...
    feat_pilotage_court: "Qui a payé, qui doit, quelle pièce manque.",
    feat_payment_court: "En une fois ou en dix, prélevé tout seul.",
    feat_emails_court: "Dix mails prêts, personnalisables, journalisés.",
    feat_waitlist_court: "La place libérée va au suivant, en 48 h.",
    feat_essai_court: "Une séance réservée, un rappel deux jours avant.",
    feat_rentree_court: "Les anciens d’abord, puis tout le monde.",
    feat_season_court: "Vos cours et tarifs repris en un clic.",
    feat_website_court: "Planning, tarifs, actus, retouchés par IA.",
    feat_shop_court: "Tenues par taille, stock, feuille de préparation.",
    feat_assistant_court: "Une question, une liste, une relance : Onie prépare.",
  ...
  en: {
    ...
    feat_pilotage_court: "Who paid, who still owes, which document is missing.",
    feat_payment_court: "In one go or in ten, charged on its own.",
    feat_emails_court: "Ten emails ready, personalised, logged.",
    feat_waitlist_court: "The freed-up place goes to the next in line, within 48 h.",
    feat_essai_court: "A booked session, a reminder two days before.",
    feat_rentree_court: "Returning families first, then everyone.",
    feat_season_court: "Your classes and prices carried over in one click.",
    feat_website_court: "Schedule, prices, news, edited by AI.",
    feat_shop_court: "Outfits by size, stock, packing sheet.",
    feat_assistant_court: "A question, a list, a reminder: Onie prepares.",
  ...
  es: {
    ...
    feat_pilotage_court: "Quién ha pagado, quién debe, qué justificante falta.",
    feat_payment_court: "De una vez o en diez, cobrado solo.",
    feat_emails_court: "Diez emails listos, personalizables, registrados.",
    feat_waitlist_court: "La plaza liberada va al siguiente, en 48 h.",
    feat_essai_court: "Una sesión reservada, un recordatorio dos días antes.",
    feat_rentree_court: "Los antiguos primero, luego todos.",
    feat_season_court: "Tus clases y tarifas recuperadas en un clic.",
    feat_website_court: "Horarios, tarifas, noticias, retocados por IA.",
    feat_shop_court: "Equipaciones por talla, stock, hoja de preparación.",
    feat_assistant_court: "Una pregunta, una lista, un recordatorio: Onie prepara.",
